...
if __name__ == "__main__":
    ...
    while True:
        ...
        '''However, I have added the possibility to draw a (coloured) rectangle around the text, by adding a rect and a rect_color parameter to the __init__() function and adding
